...
class SegFirstSwinConfig:
    ...
    pretrained_path: str = "Swin-Unet/pretrained_ckpt/swin_tiny_patch4_window7_224.pth"
    swin_cfg_path: str = "Swin-Unet/configs/swin_tiny_patch4_window7_224_lite.yaml"
    ...
    def __post_init__(self):
        if not self.work_dir:
            ...
            self.work_dir = os.path.join(
                "methods", "segfirst_multitask_swinunet", "results", f"run_{timestamp}"
            )
