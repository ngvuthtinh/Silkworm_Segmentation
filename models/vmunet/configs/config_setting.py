...
class setting_config:
    ...
    datasets = 'silkworm' 
    import os
    if datasets == 'silkworm':
        data_path = os.path.abspath(os.path.join(os.path.dirname(__file__), '../../../data/silkworm')) + '/'
    ...
    train_transformer = transforms.Compose([
        ...
        myColorJitter(p=0.5, brightness=0.2, contrast=0.2),
        myRandomAffine(p=0.5, degrees=(-20, 20), translate=(0.1, 0.1), scale=(0.85, 1.15)),
